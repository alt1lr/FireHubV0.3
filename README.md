...
Tab10Section:NewButton("British Hub V7", "", function()
...
Tab1Section:NewButton("Undead Boss", "Teleport", function()
...
Tab2Section:NewToggle("Auto Get Diamond", "Auto Get Diamond", function(state)
    if state then
Off2.Visible = true
...
local Tab4 = Window:NewTab("Home Work Lifting Simulator")
local Tab4Section = Tab4:NewSection("Home Work Lifting Simulator")

local Tab6 = Window:NewTab("Thief Simulator")
local Tab6Section = Tab6:NewSection("Thief Simulator")

local Tab7 = Window:NewTab("Blood Moon Tycoon")
local Tab7Section = Tab7:NewSection("Blood Moon Tycoon")

Tab4Section:NewToggle("Auto Weight", "", function(state)
    if state then
wait()
getgenv().auto1 = true
while getgenv().auto1 == true do
spawn(function()
game.Players.LocalPlayer.Character.Humanoid:EquipTool(game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Weights"))
end)
wait(0.1)
end
    else
getgenv().auto1 = false
while getgenv().auto1 == false do
spawn(function()
game.Players.LocalPlayer.Character.Humanoid:EquipTool(game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Weights"))
end)
wait(0.1)
...
Tab4Section:NewToggle("Auto Rebirth", "", function(state)
    if state then
getgenv().auto3 = true
...
Tab4Section:NewToggle("Auto Kill Teacher", "", function(state)
    if state then
wait()
getgenv().auto4 = true
while getgenv().auto4 == false do
spawn(function()
game.Players.LocalPlayer.Character.Humanoid:EquipTool(game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fight"))
local old = game.Players.LocalPlayer.Character:getChildren()
for i=1,#old do
if old[i].Name == "HumanoidRootPart" then
lastPos = old[i].CFrame
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace:FindFirstChild("Evil Teacher").Accessories.Hair.CFrame
wait(0.1)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = lastPos
end)
wait(3)
...
Tab6Section:NewToggle("Auto Cash", "", function(state)
    if state then
Off.Visible = true
...
Tab7Section:NewToggle("Auto Rebirth", "", function(state)
    if state then
...
Tab7Section:NewToggle("Auto Kill Zombie", "", function(state)
    if state then
getgenv().AutoKillZombies = true
while getgenv().AutoKillZombies == true do
...
getgenv().AutoKillZombies = false
while getgenv().AutoKillZombies == false do
for i,v in pairs(workspace:children()) do
if v:findFirstChildOfClass("Humanoid") and v:findFirstChild("Head") and not game.Players:GetPlayerFromCharacter(v) then
game.ReplicatedStorage.DamageEvent:FireServer(v:findFirstChildOfClass("Humanoid"), v:findFirstChildOfClass("Humanoid").Health)
end
...
local Tab7Section = Tab7:NewSection("Other")

Tab7Section:NewButton("Get Rubies", "", function()
game.ReplicatedStorage.BuyItemFunction:InvokeServer("EmojiHatFrame",-100000)
end)

Tab7Section:NewButton("Get Sapphire", "", function()
game.ReplicatedStorage.BuySapphireItemFunction:InvokeServer("HealingOrb",-100000)
end)
end)
...
Tab10Section:NewButton("Lx Hub", "FE animations for r6 and r15", function()
